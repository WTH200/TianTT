...
class UserClass {
        ...
        if (t == "gpt") {
            if (z.result == 1 && z.data.answerDetail.correct) {
                if (o == 9) {
                    ...
                    $.log(this.idx + ": 嗷呜嗷呜~, 10 道题全对了, 当前金币:" + z.data.amount.current, {
                        "notify": true
                    });
                } else {
            ...
            if (t == "database") {
                if (z.result == 1 && z.data.answerDetail.correct) {
                    o == 9 ? $.log(this.idx + ": 嗷呜嗷呜~, 10 道题全对了, 当前金币:" + z.data.amount.current, {
                        "notify": true
    ...
    async ["checkDatabase"](Z, y) {
        const o = {
            "method": "get",
            "url": "http://117.78.6.26:9398/answer?question=" + Z,
            "headers": {
                "Content-Type": "application/json",
            }
        };
