...
#################################
'''
入口：微信打开：http://www.kkdouqa.cn?masterid=oEgG856dkynb68KJfzNH3x54BSe8
 作者：newhackerman
 日期：2023-10-15
 功能 	街电充电宝  骗子项目 ,不要充钱
  header:unionid token
    变量格式：export jdcdbck='unionid&token'
 定时：1天一次
 cron: 2 8 * * *
 无邀请码
 用于青龙，其它平台未测试
...
class tasks ():#line:5
    def __init__ (OOOO0OOO0OO0O00OO ,OO00O0OOO00O0OO00 ,O00O0OOOO0O0O00OO ,OOO0O0O0OO0O0O000 ):#line:6
        ...
        OOOO0OOO0OO0O00OO .headers ={'Host':'www.hmytuea.cn','Connection':'keep-alive','Content-Length':'42','User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36','unionid':OOOO0OOO0OO0O00OO .unionid ,'token':OOOO0OOO0OO0O00OO .token ,'Content-Type':'application/json','Accept':'*/*','Origin':'http://www.ngsuazw.cn','Referer':'http://www.ngsuazw.cn/','Accept-Encoding':'gzip, deflate','Accept-Language':'zh-CN,zh;q=0.9,en;q=0.8'}#line:14
    def runtasklist (OOOOO0O00000OOO00 ):#line:15
        ...
        sendNotify .send ('执行结果：',OOOOO0O00000OOO00 .resultdict )#line:20
    def jdcdbck_sign (O0OOOOO000O00O0O0 ):#line:21
        OOO0O0000O0OOOOO0 =base64 .decodebytes ('aHR0cDovL3d3dy5obXl0dWVhLmNuL3VzZXIvYWRkbXlvcmRlcjA='.encode ('utf8'))#line:22
        OO0OOO0O0O00O0OOO =OOO0O0000O0OOOOO0 #line:23
        O0OO00OO00O000OOO ={"unionid":O0OOOOO000O00O0O0 .unionid }#line:24
        try :#line:25
            OOOOOOOO0OO0O0O00 =session .post (url =OO0OOO0O0O00O0OOO ,headers =O0OOOOO000O00O0O0 .headers ,json =O0OO00OO00O000OOO ,timeout =5 )#line:26
    ...
    def jdcdbck_pushcash (O0O00O0O00O0OO000 ):#line:35
        OOOO0O0000O0O00OO =base64 .decodebytes ('aHR0cDovL3d3dy5obXl0dWVhLmNuL3RyYWRlL3B1c2hjYXNo'.encode ('utf8'))#line:36
        OO0O00O0O0O00O0O0 =OOOO0O0000O0O00OO #line:37
        O0O000O0O0O00000O ={"unionid":O0O00O0O00O0OO000 .unionid ,"money":0.2 }#line:38
        try :#line:39
            O000O00O0O000OO0O =session .post (url =OO0O00O0O0O00O0O0 ,headers =O0O00O0O00O0OO000 .headers ,json =O0O000O0O0O00000O ,timeout =5 )#line:40
